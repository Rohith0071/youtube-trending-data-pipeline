...
datasource0 = glueContext.create_dynamic_frame.from_catalog(
    database="youtube-projectrawdata-db",
...
# Convert DynamicFrame to DataFrame (optional optimization)
datasink1 = dropnullfields3.toDF()
...
datasink4 = glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={
        "path": "s3://youtube-projectrawdata-cleansed-data/youtube/raw_statistics/",
